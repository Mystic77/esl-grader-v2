...
const users = [
  {
    name: 'Jasper',
    email: 'jasper@eslg.com',
    password: bcrypt.hashSync('ZweiHander', 10),
    feedback: [
      {
  ...
  },
  {
    name: 'Dave',
    email: 'dave@eslg.com',
    password: bcrypt.hashSync('RugbyPlug', 10),
    feedback: [
      {
        category: 'Pronunciation',
        mainText: [
  ...
  {
    name: 'Kerin',
    email: 'kerin@eslg.com',
    password: bcrypt.hashSync('LovelyGardens', 10),
    feedback: [
      {
        category: 'Pronunciation',
        mainText: [
  ...
  },
  {
    name: 'Kris',
    email: 'kris@eslg.com',
    password: bcrypt.hashSync('Mannequin', 10),
    feedback: [
      {
        category: 'Pronunciation',
        mainText: [
